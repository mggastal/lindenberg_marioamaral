...
# CONFIG
# ══════════════════════════════════════════════════════
SHEET_ID         = "1J1leJIa6O2NFgkX16h5gyUouZ9nU4v-o7PZHCedFQxY"
TEMPLATE_FILE    = "dashboard_lancamento_gratuito.html"
OUTPUT_FILE      = "index.html"

NOME_CLIENTE     = "Lindenberg Mário Amaral"
LOGO_LETRA       = "MA"
COR_ACENTO       = "#FF0000"
...
CPL_BOM          = 90.0    # Custo por Lead ≤ 5 → verde | 5-10 → amarelo | acima → vermelho
CPL_MEDIO        = 130.0
CTR_BOM          = 0.8    # CTR ≥ 1.2% → verde | 0.8-1.2% → amarelo | abaixo → vermelho
CTR_MEDIO        = 0.6
CR_BOM           = 1.0   # Connect Rate ≥ 40% → verde | 25-40% → amarelo | abaixo → vermelho
CR_MEDIO         = 0.5
